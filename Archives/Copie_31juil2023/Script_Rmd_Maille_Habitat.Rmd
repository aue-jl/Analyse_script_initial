...
<span style="color:red"><strong>Commentaire personnel : </strong> l'utilisation de la fonction winsorisation dans notre cas (échantillon de petite taille) ne me semble pas pertinente car elle génère une importante perte d'information. Par exemple, Bastia possède un taux de logements sociaux beaucoup plus élevé que les autres communes corses (21,4 % contre seulement 12,1 % pour Vescovato qui arrive 2^ème^ position). Cette information est donc perdue en appliquant la winsorization, la nouvelle valeur attribuée pour Bastia étant de 10,0 % </span>
...
```{r, echo=F,fig.align='center',fig.show='hold' ,fig.width = 9, fig.height = 9}
...
<a href="Cartes_Interactives/carte_interactive_1.html" target="_blank"><img src="Cartes_Interactives/carte1.jpg" alt=" "></a>
...
```{r trace_arbre_poids_minimal, echo=F,fig.align='center',fig.show='hold' ,fig.width = 9, fig.height = 9}
...
for (i in seq_len(nrow(arbre_poids_minimal))) {
    carte <- addPolylines(carte2, lng = c(coords[arbre_poids_minimal[i,1],1], coords[arbre_poids_minimal[i,2],1]), lat = c(coords[arbre_poids_minimal[i,1],2], coords[arbre_poids_minimal[i,2],2]), color = "red", weight = 1.5)
}
...
<br>
*Cliquer sur l'image pour afficher la carte interactive*
<a href="Cartes_Interactives/carte_interactive_2.html" target="_blank"><img src="Cartes_Interactives/carte2.jpg" alt=" "></a>
...
```{r trace_carteMaille1, echo=F,fig.align='center',fig.show='hold' ,fig.width = 9, fig.height = 9}
...
<br>
*Cliquer sur l'image pour afficher la carte interactive*
<a href="Cartes_Interactives/carte_interactive_3.html" target="_blank"><img src="Cartes_Interactives/carte3.jpg" alt=" "></a>
...
```{r traceSecteurs, echo=F,fig.align='center',fig.show='hold' ,fig.width = 9, fig.height = 9}
...
<br>
*Cliquer sur l'image pour afficher la carte interactive*
<a href="Cartes_Interactives/carte_interactive_4.html" target="_blank"><img src="Cartes_Interactives/carte4.jpg" alt=" "></a>
